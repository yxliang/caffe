...
if(MSVC)
  ...
  FIND_PACKAGE(HDF5 COMPONENTS C HL NO_MODULE REQUIRED static)#find_package(HDF5 COMPONENTS C HL REQUIRED)
  # set(HDF5_LIBRARIES hdf5-shared)
  # set(HDF5_HL_LIBRARIES hdf5_hl-shared)
  get_filename_component(_DIR "${HDF5_DIR}" PATH)
  message(STATUS "_DIR ${_DIR}")
  if(HDF5_FOUND)
	message(STATUS "HDF5 FOUND")
	message(STATUS "HDF5_LIBRARIES:${HDF5_LIBRARIES}")
  endif(HDF5_FOUND)
  set(HDF5_LIBRARIES ${HDF5_DIR}/../lib/libhdf5.lib)
  set(HDF5_HL_LIBRARIES ${HDF5_DIR}/../lib/libhdf5_hl.lib)
else()
